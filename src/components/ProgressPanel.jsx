...
const styles = {
  ...
  printBtn: {
    ...
    fontFamily: "'Nunito', 'Noto Sans', sans-serif", fontWeight: 700, fontSize: '0.875rem',
  ...
  barName: { fontWeight: 700, color: 'var(--text-dark)', flex: 1, fontFamily: "'Nunito', 'Noto Sans', sans-serif" },
  ...
  moodLink: { fontFamily: "'Nunito', 'Noto Sans', sans-serif", fontWeight: 400, fontSize: '0.8rem', color: 'var(--text-mid)' },
...
const pr = {
  ...
  emailTeacherBtn: {
    ...
    color: '#3D1A5E', cursor: 'not-allowed', fontFamily: "'Nunito', 'Noto Sans', sans-serif",
  },
