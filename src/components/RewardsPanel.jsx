export default function RewardsPanel({ mode }) {
  return (
    <div className="panel-enter" style={styles.wrapper}>
      <div style={styles.card}>
        ...
        <p style={styles.desc}>
          {mode === 'child'
            ? 'Earn stars and collect all 8 amazing badges! Keep learning to unlock them all! 🏆'
            : 'Star counter and 8-badge reward system with earned/locked states. Progress persists via localStorage. Coming in Phase 2.'}
        </p>
