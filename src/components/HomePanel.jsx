...
const s = {
  ...
  activityCard: {
    ...
    transition: 'transform 0.25s ease, box-shadow 0.25s ease', fontFamily: "'Nunito', 'Noto Sans', sans-serif",
  },
  ...
  editNameBtn: {
    ...
    padding: '4px 0', minHeight: '44px', fontFamily: "'Nunito', 'Noto Sans', sans-serif",
  },
  gdprCard: {
  ...
  gdprBtn: {
    ...
    fontFamily: "'Nunito', 'Noto Sans', sans-serif", fontWeight: 600, minHeight: '36px',
...
const dc = {
  ...
  optBtn: {
    ...
    fontFamily: "'Nunito', 'Noto Sans', sans-serif", fontWeight: 700, fontSize: '0.9rem',
