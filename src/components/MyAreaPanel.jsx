...
const s = {
  ...
  input:           { width: '100%', padding: '12px 16px', borderRadius: 40, border: '2px solid rgba(61,26,94,0.2)', fontFamily: "'Nunito', sans-serif", fontSize: '1rem', color: 'var(--text-dark)', outline: 'none', boxSizing: 'border-box', marginBottom: 12, background: 'var(--cream)', letterSpacing: 1 },
  ...
  skipBtn:         { display: 'block', width: '100%', background: 'none', border: 'none', color: 'var(--text-mid)', fontFamily: "'Nunito', sans-serif", fontSize: '0.875rem', cursor: 'pointer', textDecoration: 'underline', marginTop: 12, padding: '8px 0' },
  ...
  catChip:         { padding: '8px 16px', borderRadius: 40, border: 'none', fontFamily: "'Nunito', sans-serif", fontSize: '0.85rem', cursor: 'pointer', transition: 'background 0.2s ease, color 0.2s ease', whiteSpace: 'nowrap', minHeight: 44 },
  ...
  factCard:        { background: '#fff', borderRadius: 16, padding: 16, boxShadow: 'var(--shadow-small)', textAlign: 'left', width: '100%', fontFamily: "'Nunito', sans-serif", cursor: 'pointer', transition: 'transform 0.2s ease' },
  ...
  changeAreaBtn:   { background: 'none', border: '1px solid rgba(61,26,94,0.2)', borderRadius: 40, padding: '10px 20px', fontFamily: "'Nunito', sans-serif", fontSize: '0.875rem', color: 'var(--text-mid)', cursor: 'pointer' },
